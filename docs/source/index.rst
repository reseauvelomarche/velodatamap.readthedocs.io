...
Elle est accessible en consultation libre au public à l'adresse `velodatamap.velo-territoires.org <https://velodatamap.velo-territoires.org>`_, et en accès connecté à l'adresse `velodatamap.velo-territoires.org/vmap/login <https://velodatamap.velo-territoires.org/vmap/login>`_
